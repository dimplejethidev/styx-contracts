...
import {IBasePool, IMinimalSwapInfoPool, IVault, IPoolSwapStructs} from "../interfaces/adapters/IBalancerV2.sol";

contract BalancerV2Adapter is StyxAdapter {
